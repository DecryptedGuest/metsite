...
async function sendCustomNotification({ userIds, all, title, body, url, actions, viewUrl, claimUrl, claimApi, claimToken, ticketId, requireInteraction, vibrate, tag }) {
  ...
  try {
    ...
    await deliver(targets, { title, body, url: url || '/dashboard', actions, viewUrl, claimUrl, claimApi, claimToken, ticketId, requireInteraction, vibrate, tag });
