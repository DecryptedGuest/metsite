  ...
  try{
    ...
    var ph=Array.isArray(t.proofImages)&&t.proofImages.length
      ?"<div class=\"proof-preview-grid proof-preview-grid-detail\">"+
        t.proofImages.map(function(src,i){var s=escapeHtml(src);return "<a href=\""+s+"\" onclick=\"return metImgGallery(this)\" class=\"proof-thumb met-evid\"><img src=\""+s+"\" loading=\"lazy\"/></a>";}).join("")+"</div>"
